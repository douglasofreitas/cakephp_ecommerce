...
<?php echo $this->Form->create('Subcategoria', array('url' => array('controller' => 'subcategorias', 'action' =>'add'), 'class' => 'formulario'));
	echo $this->Form->input('id');
	
        
	echo '<label class="formulario">Categoria *</label>';
	echo $this->Form->select('categoria_id', $select_categorias, $categoria_id,  array('empty' => false));
	echo '<br/>';
