...
<?php
echo $this->Form->create('Fotoheader', array('enctype' => 'multipart/form-data', 'url' => array('controller' => 'fotoheaders', 'action' =>'edit'), 'class' => 'formulario', 'id' => 'formvalidade'));
...
echo '<label class="formulario" >Trocar imagem</label>';
?>
